...
export default function App() {
  ...
  return <main>
    <header className="nav"><a className="brand" href="/">Vectraa<span>.</span></a><nav className="navLinks"><a href="#how-it-works">How it works</a><a href="#privacy">Privacy</a><a href="#faq">FAQ</a></nav><div className="privacy">Private by design · processed on your device</div></header>
    ...
    <footer className="footer"><a className="brand" href="/">Vectraa<span>.</span></a><p>Anything → Vector. Private, local-first SVG conversion.</p><nav><a href="#how-it-works">How it works</a><a href="#privacy">Privacy</a><a href="#faq">FAQ</a></nav></footer>
  </main>;
}
